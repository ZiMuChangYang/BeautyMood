...
const mediaConfig = {
    video: [
        ...
        "http://yzkzapi.com/api/",
        "https://api.mmp.cc/api/miss?type=mp4",
        "https://www.yviii.com/video/i.php",
        "https://www.yviii.com/video/suiji.php",
        "http://api.yujn.cn/api/xinggan.php",
        "http://api.yujn.cn/api/qipao.php",
        "http://api.yujn.cn/api/wudao.php",
        "http://api.yujn.cn/api/yundong.php",
        "http://api.yujn.cn/api/xiaohua.php",
        "http://api.yujn.cn/api/keai.php",
        "http://api.yujn.cn/api/qingxin.php",
        "http://api.yujn.cn/api/gufeng.php",
        "http://api.yujn.cn/api/jiedao.php",
        "http://api.yujn.cn/api/shenmi.php",
        "http://api.yujn.cn/api/huoli.php",
        "http://api.yujn.cn/api/wenrou.php",
        "http://api.yujn.cn/api/yangguang.php",
        "http://api.yujn.cn/api/tianzhen.php",
        "http://api.yujn.cn/api/zhiyu.php",
        "http://api.yujn.cn/api/qingchun2.php",
        ...
        "https://api.r10086.com/动漫综合2.php"
    ]
};
...
class MediaApp {
    ...
    nextMedia() {
        ...
        if (this.isRandomMode) {
            ...
            this.currentIndex = (this.currentIndex + 1) % mediaConfig['video'].length;
        }
        this.loadMedia();
    }
    prevMedia() {
    ...
    toggleFavorite() {
        ...
        const favoriteIndex = this.favorites.indexOf(currentUrl);
        if (favoriteIndex === -1) {
            this.favorites.push(currentUrl);
        } else {
    ...
    updateFavoriteButton() {
        ...
        if (favoriteBtn) {
            const currentUrl = mediaConfig['video'][this.currentIndex];
            const isFavorited = this.favorites.includes(currentUrl);
            if (isFavorited) {
